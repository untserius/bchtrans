...
public class AdvancedTarifBilling {
	...
	public String toString() {
		return "AdvancedTarifBilling [sessionUniqueId=" + sessionUniqueId + ", elementId=" + elementId + ", priceId="
				+ priceId + ", restrictionId=" + restrictionId + ", restrictionType=" + restrictionType + ", priceType="
				+ priceType + ", price=" + price + ", vatPer=" + vatPer + ", vatValue=" + vatValue + ", stepSize="
				+ stepSize + ", cost=" + cost + ", costWithVat=" + costWithVat + ", StartValue=" + StartValue
